...
simulate_game(Input* input, float dt)
{
	...
	if (current_gamemode == GM_GAMEPLAY) 
	{
		...
		{
			draw_text("LEFT WINS", -40, 5, 1.5, 0xffffff);
			draw_text("PRESS ESC TO EXIT", -38, -10, 0.5, 0xffffff);
			ball_dp_x = 0;
			ball_dp_y = 0;
		}
		...
		{
			draw_text("RIGHT WINS", -45, 5, 1.5, 0xffffff);
			draw_text("PRESS ESC TO EXIT", -38, -10, 0.5, 0xffffff);
			ball_dp_x = 0;
			ball_dp_y = 0;
		}			
	...
	else 
	{
		...
		if (hot_button == 0)
		{
			draw_text("VERSUS CPU", -70, -10, 1, 0xffffff);
			draw_text("TWO PLAYER", 10, -10, 1, 0x838383);
			
		}
		else 
		{
			draw_text("VERSUS CPU", -70, -10, 1, 0x838383);
			draw_text("TWO PLAYER", 10, -10, 1, 0xffffff);
		}

		draw_text("PONG", -73, 40, 4, 0xffffff);
